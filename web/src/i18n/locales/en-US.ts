export default {
    ...
    imageWorkbench: {
        ...
        modeSet: "E-commerce set",
    },
    ecommerceSet: {
        title: "E-commerce set",
        untitled: "Untitled set",
        titlePlaceholder: "Set name",
        tasks: "Set tasks",
        newTask: "New set",
        noTasks: "No set tasks yet",
        deleteTasks: "Delete set tasks",
        deleteTasksConfirm: "Delete the selected {{count}} set tasks? Originals still used by assets or a canvas are kept.",
        progressCount: "{{done}}/{{total}} images",
        references: "Product originals",
        noReferences: "No product originals yet. Drop images here or upload them.",
        referenceSoftLimit: "Past {{count}} product originals, references crowd out the generated shots in each review batch. Keep only the ones that best describe the product.",
        privacyHint: "Product originals are sent at full resolution to the vision and image services you configured. Make sure these images may leave your machine.",
        referenceRoles: { main: "Main", packaging: "Packaging", detail: "Detail", size: "Size reference", other: "Other" },
        referenceRoleHints: {
            main: "main,hero,front,cover",
            packaging: "package,packaging,box,carton",
            detail: "detail,closeup,close-up,macro,texture",
            size: "size,scale,dimension,measure",
        },
        style: "Visual style",
        customStylePlaceholder: "Extra style notes (optional), applied on top of the selected preset",
        customStyleRequired: "Describe your custom style",
        styles: {
            studioClean: "Clean studio",
            studioCleanText: "Clean studio look, solid or soft grey gradient background, even key light with light fill, realistic contact shadows, neutral white balance, commercial-grade sharpness.",
            lifestyleWarm: "Warm lifestyle",
            lifestyleWarmText: "Warm lifestyle setting, natural window light, real materials such as wood or fabric, shallow depth of field, soft warm tones, relaxed and believable styling.",
            premiumDark: "Premium dark",
            premiumDarkText: "Premium dark look, deep background, strong directional side light with rim light, restrained highlights, clear warm-cool contrast, emphasis on material and craft.",
            ecommerceBright: "Bright marketplace",
            ecommerceBrightText: "Bright marketplace hero style, pure white or near-white background, high even lighting, minimal shadow, product filling most of the frame, clean sharp edges suitable for white-background listing rules.",
            outdoorNatural: "Natural outdoor",
            outdoorNaturalText: "Natural outdoor light, real skylight and environmental reflections, foliage or outdoor materials in the background, airy feel, true daylight colour temperature.",
            custom: "Custom",
        },
        globalPrompt: "Global prompt",
        globalPromptPlaceholder: "Requirements for the whole set, such as brand tone, audience, or target platform",
        avoidPrompt: "Things to avoid",
        avoidPromptPlaceholder: "What every shot must avoid, such as watermarks, competitor products, or people",
        profile: "Product profile",
        analyze: "Analyse product",
        reanalyze: "Re-analyse",
        visionModelHint: "Product analysis and visual review use the text model {{model}}. It must accept image input, otherwise analysis fails.",
        profileEmpty: 'No product profile yet. Run "Analyse product" to build one from the originals.',
        profileNeedsReferences: "Upload product originals before running the analysis",
        profileDetails: "Materials, colours, packaging, and constraints",
        profileFields: {
            ...
            materials: "Materials",
            colors: "Colours",
            surfaceDetails: "Surface details",
        ...
        shotsTitle: "Shot prompts",
        planPrompts: "Plan prompts",
        replan: "Re-plan",
        replanHint: "After editing the product profile, re-plan so the prompts pick up your changes.",
        noPrompt: "Not planned",
        viewPrompt: "View and edit the prompt that is actually sent",
        moveUp: "Move up",
        moveDown: "Move down",
        enableShot: "Enable this shot",
        disableShot: "Disable this shot",
        enabled: "Enabled",
        disabled: "Disabled",
        shots: {
            hero: "Hero shot",
            heroBrief: "The opening image: the complete product, front or slight three-quarter view, centred and dominant, so the product reads instantly.",
            material: "Material detail",
            materialBrief: "Macro or close shot focused on material texture, surface finish, seams, and edges, with shallow depth of field.",
            scene: "In use",
            sceneBrief: "The product in a real usage setting, showing how and where it is used, with the product still the clear subject.",
            feature: "Key selling point",
            featureBrief: "Built around the single strongest selling point, using angle, a partial close-up, or structure to make that point obvious.",
            packaging: "Packaging and size",
            packagingBrief: "Packaging, specification, or size relationship, optionally unboxed or compared against a familiar reference object.",
            closing: "Closing shot",
            closingBrief: "The closing image: more negative space and restraint, suitable for the end of a listing page or as a campaign background.",
            custom: "Custom shot",
        },
        addShot: "Add shot",
        duplicateShot: "Duplicate shot",
        removeShot: "Remove shot",
        removeShotBlocked: "Keep at least one shot",
        copySuffix: "copy",
        stale: "Needs regeneration",
        customShotLabelPlaceholder: 'Shot name, e.g. "held by model"',
        customShotBriefPlaceholder: "Shot brief: what this image shows, its framing and its focus",
        requestSummary: "Request summary",
        summaryModel: "Model {{model}} · size {{size}} · quality {{quality}}",
        summaryShots: "{{count}} shots, one separate request per shot",
        summaryReferences: "{{count}} product references, sent with each request numbered {{labels}}",
        generateSet: "Generate {{count}} shots",
        generateRemaining: "Generate remaining {{count}} shots",
        generateBlockedPlanStale: "Settings changed. Re-plan the shots first",
        generateBlockedNoSlots: "Enable at least one shot first",
        generateBlockedAllDone: "Every shot is generated. Regenerate individual shots as needed",
        stop: "Stop",
        results: "Set results",
        emptyResults: "No shots generated yet",
        deliverableCount: "{{count}} originals saved",
        attempts: "{{count}} attempts",
        review: "Run vision review",
        ...
        reviewUnreviewed: "Review {{count}} unreviewed",
        reviewUnreviewedHint: "Only reviews images without a verdict yet, including ones cleared by a regenerate. Existing verdicts stay unchanged.",
        reviewManual: "Re-review {{count}} flagged",
        reviewManualHint: "Only re-reviews images flagged for a manual look. Other verdicts stay unchanged.",
        applyReviewFix: "Apply review notes",
        applyReviewFixHint: "Write the review findings into this shot's prompt and regenerate just this image.",
        regenerateAll: "Regenerate all",
        regenerateAllHint: "Regenerate every enabled shot from the current prompts. This overwrites existing results.",
        ...
        downloadedOriginal: "Downloaded the generated original",
        exportZip: "Export ZIP",
        exported: "Exported {{count}} originals with the task manifest",
        savedToAssets: "Saved {{count}} originals to My Assets",
        sendToCanvas: "Send to canvas",
        sentToCanvas: "Created a canvas with {{count}} original image nodes",
        appendToCanvas: 'Append to "{{title}}"',
        appendedToCanvas: "Appended {{count}} original image nodes to the canvas",
        noCanvasProjects: "No existing canvases",
        moreCanvasProjects: "See all in the canvas list ({{count}} more)",
        status: {
            draft: "Draft",
            analyzing: "Analysing product",
            planning: "Planning prompts",
            prompt_ready: "Prompts ready",
            generating: "Generating",
            generated: "Generated",
            reviewing: "Reviewing",
            reviewed: "Reviewed",
        ...
        errors: {
            jsonMissing: "The model returned no JSON. Retry, or switch to a model that supports structured output.",
            jsonInvalid: "The JSON returned by the model could not be parsed. Please retry.",
            profileIncomplete: "The product profile is missing required fields ({{fields}}). Please re-analyse.",
            slotPromptMissing: '"{{slot}}" has no prompt. Please re-plan.',
            planIncomplete: "The prompt plan is missing shots: {{shots}}. Please re-plan.",
            reviewSlotMissing: 'The review result is missing "{{slot}}". Please review again.',
            referencesRequired: "Upload product originals first",
            shotsRequired: "Enable at least one shot",
            noReviewableSlots: "There are no generated images to review",
            slotImageMissing: 'The generated original for "{{slot}}" is missing',
            noDeliverables: "There are no generated originals to deliver",
            compressDecodeFailed: "The generated image could not be decoded, so it cannot be compressed for review",
            ...
            canvasMissing: "The target canvas no longer exists. Pick another one.",
            unknown: "The operation failed",
        },
        prompts: {
            outputLanguage: "Write all output text in {{language}}.",
            referenceLine: "Reference {{index}} ({{role}}): {{name}}",
            analysisIntro: "You are an e-commerce product visual analyst. Below are several originals of the same product. Extract the product information using only what is visible in the images.",
            analysisRules:
                "Rules:\n1. Strictly separate what you can see from what you are guessing. Only record what is genuinely visible as fact.\n2. Never state an unconfirmed detail as fact; put it in usageNotes and mark it as an inference.\n3. Put product shape, materials, packaging, logos, label text, colours, and structural layers into mustKeep first.\n4. Copy visible text and logos character for character. Do not translate, rewrite, or complete them.\n5. Do not invent model numbers, specifications, certifications, or selling points that are not in the images.",
            analysisSchema:
                'Output exactly one JSON object, with no explanation and no code fences. Fields:\n{\n  "productName": "product name",\n  "category": "product category",\n  "shape": "overall shape and structural layers",\n  "materials": ["material"],\n  "colors": ["colour"],\n  "surfaceDetails": ["surface finish and detail"],\n  "packagingDetails": ["packaging detail"],\n  "visibleText": ["text and logos visible in the images, copied verbatim"],\n  "mustKeep": ["features that must stay consistent when generating"],\n  "mustAvoid": ["things that must never appear when generating"],\n  "usageNotes": ["how or where the product is used"]\n}',
            planIntro: "You are planning the visuals for an e-commerce image set. Plan prompts for {{count}} shots of the product below.",
            planStyle: "[Style]\n{{style}}",
            planGlobal: "[Global requirements]\n{{text}}",
            planAvoid: "[Avoid across the whole set]\n{{text}}",
            planShots: "[Shots to plan]",
            shotLine: "{{index}}. id={{id}}, role: {{role}}. Brief: {{brief}}",
            planRules:
                "Rules:\n1. Write only the shot layer for each shot: how the subject is presented, composition, camera angle, lighting, background, and any text requirement.\n2. Do not repeat product material, colour, or logo constraints. The system prepends those separately, and repeating them dilutes the constraint.\n3. Each prompt must stand alone as one image. Shots must not reference each other.\n4. Shots must differ clearly from one another. Do not produce several near-identical compositions.\n5. requiredElements lists what must appear in that image; avoidElements lists what must not.\n6. globalConstraints holds set-wide consistency rules, such as a shared palette, a shared light direction, or a shared amount of negative space.",
            planSchema:
                'Output exactly one JSON object, with no explanation and no code fences. Fields:\n{\n  "globalConstraints": ["set-wide constraint"],\n  "slots": [\n    {\n      "id": "shot id, exactly matching an id given above",\n      "prompt": "the shot description",\n      "requiredElements": ["must appear"],\n      "avoidElements": ["must not appear"]\n    }\n  ]\n}',
            reviewIntro: "You are the quality checker for an e-commerce image set. First come {{references}} product originals, which are the only source of truth, then {{generated}} generated images. Review each generated image.",
            reviewBatched: "This is a batched review. Judge only the generated images in this batch; the product originals are supplied in full with every batch.",
            reviewShots: "[Shots in this batch]",
            reviewShotLine: "{{index}}. slotId={{id}}, role: {{role}}",
            reviewRules:
                "Review rules:\n1. Does the product's appearance match the references?\n2. Have the product's structure, colour, or materials been wrongly altered?\n3. Do the composition and camera angle suit this shot's role?\n4. Is the text, logo, and packaging information in the generated image legible and correct?\n5. Are there extra products, duplicated subjects, deformation, missing parts, or occlusion?\n6. Are style, colour, and visual hierarchy consistent across the set?\nReport findings only. Do not propose regenerating anything and do not supply new prompts.",
            reviewSchema:
                'Output exactly one JSON object, with no explanation and no code fences. Fields:\n{\n  "summary": "overall conclusion for the set",\n  "slots": [\n    {\n      "slotId": "exactly matching a slotId given above",\n      "status": "passed or manual_review",\n      "confidence": 0.9,\n      "checks": {\n        "productConsistency": true,\n        "materialAccuracy": true,\n        "composition": true,\n        "textAccuracy": true\n      },\n      "issues": ["specific problem, or an empty array when there are none"]\n    }\n  ]\n}',
            reviewReferenceLabel: "Product original {{index}} ({{role}}):",
            reviewGeneratedLabel: "Generated image slotId={{id}} ({{role}}):",
            productHeading: "[Product consistency]",
            styleHeading: "[Style and brand visuals]",
            shotHeading: "[Current shot: {{role}}]",
            profileLine: "{{label}}: {{value}}",
            requiredLine: "Must include: {{text}}",
            avoidLine: "Must avoid: {{text}}",
            fixHeading: "[Review findings to fix]",
            fixLine: "Fix: {{text}}",
        },
    },
    videoWorkbench: {

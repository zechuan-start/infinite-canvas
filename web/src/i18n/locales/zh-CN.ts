export default {
    ...
    ecommerceSet: {
        title: "电商套图",
        untitled: "未命名套图",
        titlePlaceholder: "套图名称",
        tasks: "套图任务",
        newTask: "新建套图",
        noTasks: "暂无套图任务",
        deleteTasks: "删除套图任务",
        deleteTasksConfirm: "确定删除选中的 {{count}} 个套图任务吗？仍被素材或画布引用的原图会保留。",
        progressCount: "{{done}}/{{total}} 张",
        references: "产品原图",
        noReferences: "暂无产品原图，可拖入图片或点击上传",
        referenceSoftLimit: "产品原图超过 {{count}} 张后，复核批次留给生成图的额度会明显变少，建议只保留最能说明产品的几张",
        privacyHint: "产品原图会按原始版本发送到你配置的视觉和生图服务，请确认图片可以外发。",
        referenceRoles: { main: "主图", packaging: "包装", detail: "细节", size: "尺寸参考", other: "其他" },
        referenceRoleHints: {
            main: "主图,正面,main,hero,front,cover",
            packaging: "包装,盒子,礼盒,package,packaging,box",
            detail: "细节,特写,纹理,材质,detail,closeup,close-up,macro,texture",
            size: "尺寸,规格,大小,对比,size,scale,dimension",
        },
        style: "视觉风格",
        customStylePlaceholder: "补充风格说明（可选），会叠加在所选风格之上",
        customStyleRequired: "请填写自定义风格说明",
        styles: {
            studioClean: "干净棚拍",
            studioCleanText: "干净的棚拍质感，纯色或浅灰渐变背景，柔和均匀的主光加轻微反光板补光，真实的接触阴影，中性白平衡，商业级清晰度。",
            lifestyleWarm: "温暖生活",
            lifestyleWarmText: "温暖的生活化场景，自然窗光，木质或织物等真实材质环境，浅景深，柔和暖色调，真实随性的陈设。",
            premiumDark: "高级暗调",
            premiumDarkText: "高级暗调质感，深色背景，方向性强的侧光和边缘轮廓光，克制的高光，冷暖对比明确，突出材质与工艺的高端感。",
            ecommerceBright: "明亮电商",
            ecommerceBrightText: "明亮的电商主图风格，纯白或极浅背景，高亮度均匀照明，阴影极浅，产品占画面主体，边缘干净锐利，适合平台白底图要求。",
            outdoorNatural: "自然户外",
            outdoorNaturalText: "自然户外光线，真实天光与环境反射，自然植被或户外材质背景，通透的空气感，真实的日光色温。",
            custom: "自定义",
        },
        globalPrompt: "全局提示词",
        globalPromptPlaceholder: "适用于整套图的额外要求，例如品牌调性、目标人群、投放平台",
        avoidPrompt: "禁止项",
        avoidPromptPlaceholder: "整套图都要避免的内容，例如文字水印、竞品、人物出镜",
        profile: "产品档案",
        analyze: "分析产品",
        reanalyze: "重新分析",
        visionModelHint: "产品分析和视觉复核使用文本模型 {{model}}，需要该模型支持图片输入，否则会分析失败。",
        profileEmpty: "尚未分析产品，点击「分析产品」根据原图生成产品档案",
        profileNeedsReferences: "请先上传产品原图，再进行产品分析",
        profileDetails: "展开材质、颜色、包装与约束",
        profileFields: {
            productName: "产品名称",
            category: "类别",
            shape: "形状结构",
        ...
        planPrompts: "生成提示词",
        replan: "重新规划",
        replanHint: "修改产品档案后需要重新规划，提示词才会同步更新。",
        noPrompt: "未规划",
        viewPrompt: "查看并编辑实际发送的提示词",
        moveUp: "上移",
        moveDown: "下移",
        enableShot: "启用该镜头",
        disableShot: "关闭该镜头",
        ...
        shots: {
            hero: "系列首图",
            heroBrief: "整套图的第一张，完整展示产品全貌，构图正面或微侧，主体居中且占比突出，第一眼就能看清产品是什么。",
            material: "材质细节",
            materialBrief: "微距或近摄，聚焦材质纹理、表面工艺、拼接与边缘细节，浅景深突出质感。",
            scene: "使用场景",
            sceneBrief: "把产品放进真实使用场景，体现使用方式、摆放位置和环境关系，产品仍是画面主体。",
            feature: "核心卖点",
            featureBrief: "围绕一个最核心的卖点组织画面，通过角度、局部特写或结构展示把卖点讲清楚。",
            packaging: "包装规格",
            packagingBrief: "展示包装、规格或尺寸关系，可含开箱状态或与常见参照物的大小对比。",
            closing: "收尾图",
            closingBrief: "整套图的收尾，构图更留白克制，适合放在详情页末尾或用作活动图底图。",
            custom: "自定义镜头",
        },
        addShot: "添加镜头",
        duplicateShot: "复制镜头",
        removeShot: "删除镜头",
        removeShotBlocked: "至少保留一个镜头",
        copySuffix: "副本",
        stale: "待重新生成",
        customShotLabelPlaceholder: "镜头名称，例如「模特手持」",
        customShotBriefPlaceholder: "镜头说明，描述这一张要拍什么、构图和重点",
        requestSummary: "请求摘要",
        summaryModel: "模型 {{model}} · 尺寸 {{size}} · 质量 {{quality}}",
        summaryShots: "共 {{count}} 个镜头，每个镜头单独请求一张",
        summaryReferences: "产品参考图 {{count}} 张，按 {{labels}} 编号随请求发送",
        generateSet: "生成 {{count}} 张套图",
        generateRemaining: "继续生成剩余 {{count}} 张",
        generateBlockedPlanStale: "配置已改动, 请先重新规划分镜",
        generateBlockedNoSlots: "请先启用至少一个分镜",
        generateBlockedAllDone: "全部分镜已出图, 可对单张重新生成",
        stop: "停止",
        results: "套图结果",
        emptyResults: "还没有生成套图",
        deliverableCount: "已完成 {{count}} 张",
        ...
        reviewOne: "复核此图",
        reviewAgain: "重新复核",
        reviewUnreviewed: "复核未复核 {{count}} 张",
        reviewUnreviewedHint: "只复核还没有结论的图，包括重新生成后结论已清空的图。已有结论保留不变。",
        reviewManual: "重新复核待确认 {{count}} 张",
        reviewManualHint: "只重新复核被标为待人工确认的图，其他结论保留不变。",
        applyReviewFix: "按复核意见改写",
        applyReviewFixHint: "把复核发现的问题写进该镜头提示词并重新生成这一张。",
        regenerateAll: "全部重新生成",
        regenerateAllHint: "按当前提示词重新生成所有已启用镜头，会覆盖现有结果。",
        ...
        downloadedOriginal: "已下载生成原图",
        exportZip: "导出 ZIP",
        exported: "已导出 {{count}} 张原图和任务清单",
        savedToAssets: "已保存 {{count}} 张原图到我的素材",
        sendToCanvas: "发送到画布",
        sentToCanvas: "已创建画布并添加 {{count}} 个原图节点",
        appendToCanvas: "追加到「{{title}}」",
        appendedToCanvas: "已追加 {{count}} 个原图节点到画布",
        noCanvasProjects: "暂无已有画布",
        moreCanvasProjects: "在画布列表中查看全部 (还有 {{count}} 个)",
        status: {
            draft: "草稿",
            analyzing: "分析产品中",
            planning: "规划提示词中",
        ...
        errors: {
            jsonMissing: "模型没有返回 JSON 内容，请重试或更换支持结构化输出的模型",
            jsonInvalid: "模型返回的 JSON 无法解析，请重试",
            profileIncomplete: "产品档案缺少必要字段（{{fields}}），请重新分析",
            slotPromptMissing: "「{{slot}}」缺少提示词，请重新规划",
            planIncomplete: "提示词计划缺少镜头：{{shots}}，请重新规划",
            reviewSlotMissing: "复核结果缺少「{{slot}}」，请重新复核",
            referencesRequired: "请先上传产品原图",
            shotsRequired: "请至少启用一个镜头",
            noReviewableSlots: "没有可复核的生成图",
            slotImageMissing: "「{{slot}}」的生成原图已丢失",
            noDeliverables: "没有可交付的生成原图",
            compressDecodeFailed: "生成图解码失败，无法压缩后复核",
            ...
            canvasMissing: "目标画布已不存在，请重新选择",
            unknown: "操作失败",
        },
        prompts: {
            outputLanguage: "所有输出文本使用{{language}}。",
            referenceLine: "参考图 {{index}}（{{role}}）：{{name}}",
            analysisIntro: "你是电商产品视觉分析师。下面是同一个产品的多张原图，请只根据图片可见内容提取产品信息。",
            analysisRules:
                "规则：\n1. 严格区分「看得到的事实」和「推测」。只把图片中确实能看到的内容写成事实。\n2. 无法确认的内容不要写成确定事实，可放入 usageNotes 并说明是推测。\n3. 产品形状、材质、包装、logo、标签文字、颜色和结构层次优先写入 mustKeep。\n4. 图上可见的文字和 logo 必须逐字照抄，不要翻译、改写或补全。\n5. 不要编造图片中不存在的型号、参数、认证或卖点。",
            analysisSchema:
                '只输出一个 JSON 对象，不要输出解释文字或代码块标记。字段如下：\n{\n  "productName": "产品名称",\n  "category": "产品类别",\n  "shape": "整体形状与结构层次",\n  "materials": ["材质"],\n  "colors": ["颜色"],\n  "surfaceDetails": ["表面工艺与细节"],\n  "packagingDetails": ["包装细节"],\n  "visibleText": ["图上可见的文字与 logo，逐字照抄"],\n  "mustKeep": ["生图时必须保持一致的特征"],\n  "mustAvoid": ["生图时禁止出现的内容"],\n  "usageNotes": ["使用方式或场景说明"]\n}',
            planIntro: "你是电商套图的视觉策划。请为下面这个产品规划 {{count}} 个镜头的提示词。",
            planStyle: "【风格要求】\n{{style}}",
            planGlobal: "【全局要求】\n{{text}}",
            planAvoid: "【整套禁止项】\n{{text}}",
            planShots: "【需要规划的镜头】",
            shotLine: "{{index}}. id={{id}}，角色：{{role}}。要求：{{brief}}",
            planRules:
                "规则：\n1. 每个镜头只写「当前镜头」这一层内容：主体呈现、构图、镜头视角、光线、背景和文字要求。\n2. 不要重复产品材质、颜色、logo 等产品约束，这些会由系统单独拼接，重复会稀释约束。\n3. 每条提示词必须能独立生成一张图，镜头之间不要互相引用。\n4. 镜头之间要有明确差异，不要产出多张构图雷同的图。\n5. requiredElements 写这张图必须出现的元素，avoidElements 写这张图必须避免的元素。\n6. globalConstraints 写适用于整套图的视觉一致性约束，例如统一色调、统一光位、统一留白比例。",
            planSchema:
                '只输出一个 JSON 对象，不要输出解释文字或代码块标记。字段如下：\n{\n  "globalConstraints": ["整套图统一约束"],\n  "slots": [\n    {\n      "id": "镜头 id，必须与上面给出的 id 完全一致",\n      "prompt": "当前镜头的画面描述",\n      "requiredElements": ["必须出现的元素"],\n      "avoidElements": ["必须避免的元素"]\n    }\n  ]\n}',
            reviewIntro: "你是电商套图质检员。下面先给出 {{references}} 张产品原图作为唯一事实基准，再给出 {{generated}} 张生成图，请逐张复核。",
            reviewBatched: "本次为分批复核，只需评估本批给出的生成图，产品原图每批都会完整提供。",
            reviewShots: "【本批生成图对应的镜头】",
            reviewShotLine: "{{index}}. slotId={{id}}，角色：{{role}}",
            reviewRules:
                "复核规则：\n1. 产品外观是否和参考图一致。\n2. 产品结构、颜色和材质是否被错误改变。\n3. 构图和镜头是否符合当前镜头角色。\n4. 生成图中的文字、logo、包装信息是否清晰且正确。\n5. 是否出现额外产品、重复主体、变形、缺失或遮挡。\n6. 整套图片的风格、色彩和视觉层级是否统一。\n只输出评估结论。不要提出重新生成，也不要给出新的提示词。",
            reviewSchema:
                '只输出一个 JSON 对象，不要输出解释文字或代码块标记。字段如下：\n{\n  "summary": "整套图的总体结论",\n  "slots": [\n    {\n      "slotId": "必须与上面给出的 slotId 完全一致",\n      "status": "passed 或 manual_review",\n      "confidence": 0.9,\n      "checks": {\n        "productConsistency": true,\n        "materialAccuracy": true,\n        "composition": true,\n        "textAccuracy": true\n      },\n      "issues": ["具体问题，没有问题则为空数组"]\n    }\n  ]\n}',
            reviewReferenceLabel: "产品原图 {{index}}（{{role}}）：",
            reviewGeneratedLabel: "生成图 slotId={{id}}（{{role}}）：",
            productHeading: "【产品一致性约束】",
            styleHeading: "【风格与品牌视觉】",
            shotHeading: "【当前镜头：{{role}}】",
            profileLine: "{{label}}：{{value}}",
            requiredLine: "必须包含：{{text}}",
            avoidLine: "避免出现：{{text}}",
            fixHeading: "【复核问题修正】",
            fixLine: "需修正：{{text}}",
        },
